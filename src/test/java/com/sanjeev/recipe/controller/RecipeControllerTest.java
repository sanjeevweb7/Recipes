...
public class RecipeControllerTest {
    ...
    @Test
    public void testChangeDateFormat_withValidInput_returnResult() {
    List<Recipe> recipeList = getRecipeList();
    assertNotNull(recipeController.changeDateFormat(recipeList));
    }

    @Test
    public void testChangeDateFormat_withEmptyInput_returnNoData() {
        assertEquals(0,recipeController.changeDateFormat(new ArrayList<>()).size());
    }
